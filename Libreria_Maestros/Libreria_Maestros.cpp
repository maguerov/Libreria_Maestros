...
void menuReportes()
{
	...
	cad += "6. Desplegar lista de categorias. \n";
	cad += "7. Desplegar los libros de una categoria específica. (Muestra todo el detalle del libro) \n";
	cad += "8. Volver al menu principal. \n";
	cad += "0. Salir \n";
	cout << cad;
	cout << "\n";
...
void procesarReportes(int pOpcion)
{
	...
	case 1:
		cout << "El valor actual del inventario es de: " << l->precioInventarioTotal() << endl;
		break;

	case 2:
		cout << "La cantidad de libros agotados es de: " << l->cantidadLibrosAgotados() << endl;
		break;
